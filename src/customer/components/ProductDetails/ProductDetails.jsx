                ...
                <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
                    ...
                    lg:pb-24">
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            {/* Reviews */}
                            <div className="mt-6">
                                <div className='flex items-center space-x-3'><Rating name="read-only" value={4.5} readOnly />
                                    <p className='opacity-50 text-sm'>34564 Ratings</p>
                        ...
                        <Grid container spacing={7}>
                            ...
                            <Grid item xs={5}>
                                ...
                                <div className='flex items-center space-x-3'>
                                    ...
                                    <p className='opacity-60'>23453 Ratings</p>
                                </div>
